...
def deplacer_personnage_Haut(t_max, Cases, var2n):
    contrainte = [[var2n[('do', t, "haut")], var2n[('at', t, c1, "H")], var2n[('at', t + 1, c2, "H")], var2n[('at', t, c2, " ")]]
...
def deplacer_personnage_Bas(t_max, Cases, var2n):
    contrainte = [[var2n[('do', t, "bas")], var2n[('at', t, c1, "B")], var2n[('at', t + 1, c2, "B")], var2n[('at', t, c2, " ")]]
                 for t in range(t_max)
                 for c1 in Cases
...
def deplacer_personnage_Gauche(t_max, Cases, var2n):
    contrainte = [[var2n[('do', t, "gauche")], var2n[('at', t, c1, "G")], var2n[('at', t + 1, c2, "G")], var2n[('at', t, c2, " ")]]
                    for t in range(t_max)
                    for c1 in Cases
...
def deplacer_personnage_Droite(t_max, Cases, var2n):
    contrainte = [[var2n[('do', t, "droite")], var2n[('at', t, c1, "D")], var2n[('at', t + 1, c2, "D")], var2n[('at', t, c2, " ")]]
                    for t in range(t_max)
                    for c1 in Cases
...
def deplacer_pierre_Haut(t_max, Cases, var2n):
    contrainte = [[var2n[('do', t, "pousserHaut")], var2n[('at', t, c1, "H")], var2n[('at', t, (c1[0], c1[1] + 1), "B")],
...
def deplacer_ennemi_Haut(t_max, Cases, var2n):
    contrainte = [[var2n[('do', t, "attaquerHaut")], var2n[('at', t, c1, "H")], var2n[('at', t, (c1[0], c1[1] + 1), "M")],
                 var2n[('at', t + 1, (c1[0], c1[1] + 2), " ")],
                 var2n[('at', t + 1, (c1[0], c1[1] + 2), "B")]]
                 for t in range(t_max)
                 for c1 in Cases
...
def eliminer_ennemi_Haut(t_max, Cases, var2n):
    contrainte = [[var2n[('do', t, "tuerHaut")], var2n[('at', t, c1, "H")], var2n[('at', t, (c1[0], c1[1] + 1), "M")]]
                for t in range(t_max)
                for c1 in Cases
...
def nouvelle_map(map, t_max, Actions, Cases, var2n):
    nouvelle_map = [[var2n[('at', t, c, entite)], var2n[('at', t + 1, c, entite)], var2n[('do', t, action)]]
               for t in range(t_max)
               for c in Cases
...
def objectif(t_max, Cases, var2n):
    objectif = [[var2n[('at', t, c1, "H")], var2n[('at', t, c2, "D")]]
                for t in range(t_max)
                for c2 in Cases
...
def sat_solver(infos):
    ...
    Clauses = mapdepart + at_least_one_action + at_most_one_action + deplacement_personnage_Haut + deplacement_pierre_Haut + deplacement_ennemi_haut + elimination_ennemi_haut + nouvelle_carte + goal
